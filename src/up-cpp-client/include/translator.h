...
private:
    ...
    google::protobuf::Struct receivedMessage;
    ...
    public:
         ...
         */
        google::protobuf::Struct OpenCommunicationChannel(const std::string &toolAddress, const std::string &ecuAddress,const std::string &canFormat);
         ...
         * @return jsonType - returns jsonType type response payload
         */
        google::protobuf::Struct ReadByDataIdentifier(const std::vector<std::string> &did);
...
public:
     ...
     * @return google::protobuf::Struct - returns protobuf type
     */
    google::protobuf::Struct getResponse(const std::string &sequenceVal,
                         const int time = RETRY_TIMEOUT);
    
    /** @brief - notify method notifies other containers
     * @param topic - const string reference type
     * @param message - const string type
     */
    void notify(const std::string &topic, const std::string message);
